...
export default function LandingPage () {
  return (
    <section className={styles.hero}>
      <img src={background} className={styles.hero__background} />
      <div className={styles.hero__present}>
        <img src={dogGroups} className={styles.hero__groupdogs} />
      ...
      <img src={landingDog} className={styles.hero__img} width='650' height='650' />
    </section>
  )
}
